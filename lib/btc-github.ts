 ...
 * xong vẫn không biết gõ gì vào ô Collaborators, và câu báo lỗi lại nhắc một cái tên không xuất
 * hiện ở bất kỳ trang hướng dẫn nào.
 *
 * Đây là địa chỉ công khai, không phải bí mật: nó tồn tại để người ta thêm vào kho của họ.
 */
export const BTC_GITHUB_ACCOUNT = "git@matbao.ai";
